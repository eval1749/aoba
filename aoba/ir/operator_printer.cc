...
#include "aoba/ir/common_operators.h"
...
IMPLEMENT_IR_OPERATOR_PRINTER_0(If)
IMPLEMENT_IR_OPERATOR_PRINTER_0(IfException)
IMPLEMENT_IR_OPERATOR_PRINTER_0(IfFalse)
IMPLEMENT_IR_OPERATOR_PRINTER_0(IfSuccess)
IMPLEMENT_IR_OPERATOR_PRINTER_0(IfTrue)
