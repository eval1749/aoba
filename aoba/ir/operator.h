...
#ifndef AOBA_IR_OPERATOR_H_
#define AOBA_IR_OPERATOR_H_
...
// Operator
//
class AOBA_IR_EXPORT Operator : public Castable<Operator>,
...
#define DECLARE_IR_OPERATOR_0(name)                         \
  class AOBA_IR_EXPORT name##Operator final                \
