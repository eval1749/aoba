...
#ifndef AOBA_IR_NODE_H_
#define AOBA_IR_NODE_H_
...
// Node
//
class AOBA_IR_EXPORT Node final {
 public:
  ...
  class AOBA_IR_EXPORT Format final {
   public:
    class Builder;
  ...
  // Inputs
  class AOBA_IR_EXPORT Inputs final {
   public:
    // Iterator is a generator of input node iterator.
    class AOBA_IR_EXPORT Iterator final
  ...
  // Users
  class AOBA_IR_EXPORT Users final {
   public:
    // Iterator is a generator of input node iterator.
    class AOBA_IR_EXPORT Iterator final
        : public std::iterator<std::input_iterator_tag, const Node> {
