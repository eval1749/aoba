...
#ifndef AOBA_ANALYZER_TYPE_ANNOTATION_TRANSFORMER_H_
#define AOBA_ANALYZER_TYPE_ANNOTATION_TRANSFORMER_H_
...
#endif  // AOBA_ANALYZER_TYPE_ANNOTATION_TRANSFORMER_H_
