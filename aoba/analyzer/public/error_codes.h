...
#ifndef AOBA_ANALYZER_PUBLIC_ERROR_CODES_H_
#define AOBA_ANALYZER_PUBLIC_ERROR_CODES_H_
...
AOBA_ANALYZER_EXPORT base::StringPiece ErrorStringOf(int error_code);

}  // namespace analyzer
}  // namespace aoba

#endif  // AOBA_ANALYZER_PUBLIC_ERROR_CODES_H_
