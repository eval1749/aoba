...
#ifndef AOBA_AST_NODE_FACTORY_H_
#define AOBA_AST_NODE_FACTORY_H_
...
// NodeFactory
//
class AOBA_AST_EXPORT NodeFactory final {
 public:
  ...
  const Node& NewTypeName(const Node& name);
...
#endif  // AOBA_AST_NODE_FACTORY_H_
