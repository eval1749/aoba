...
#ifndef AOBA_AST_SYNTAX_H_
#define AOBA_AST_SYNTAX_H_
...
// Syntax
//
class AOBA_AST_EXPORT Syntax : public Castable<Syntax>, public ZoneAllocated {
...
#define DECLARE_AST_SYNTAX_0(name)                                    \
  class AOBA_AST_EXPORT name final : public SyntaxTemplate<Syntax> { \
...
#define DECLARE_AST_SYNTAX_1(name, type1, parameter1)                        \
  class AOBA_AST_EXPORT name final : public SyntaxTemplate<Syntax, type1> { \
    DECLARE_CONCRETE_AST_SYNTAX(name, Syntax);                               \
                                                                             \
   public:                                                                   \
    ~name();                                                                 \
...
#define DECLARE_AST_SYNTAX_2(name, type1, parameter1, type2, member2) \
  class AOBA_AST_EXPORT name final                                   \
