...
#ifndef AOBA_AST_NODE_TRAVERSAL_H_
#define AOBA_AST_NODE_TRAVERSAL_H_
...
// ChildNodes
//
class AOBA_AST_EXPORT ChildNodes final {
 public:
  class AOBA_AST_EXPORT Iterator final
...
//
class AOBA_AST_EXPORT InclusiveDescendants {
 public:
  class AOBA_AST_EXPORT Iterator final
      : public std::iterator<std::input_iterator_tag, const Node> {
   public:
...
// NodeTraversal
//
class AOBA_AST_EXPORT NodeTraversal final {
 public:
...
#endif  // AOBA_AST_NODE_TRAVERSAL_H_
