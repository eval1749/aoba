...
#ifndef AOBA_AST_SYNTAX_FACTORY_H_
#define AOBA_AST_SYNTAX_FACTORY_H_
...
// SyntaxFactory
//
class AOBA_AST_EXPORT SyntaxFactory final {
 public:
...
#define DECLARE_FACTORY_MEMBER_2(name, type1, parameter1, type2, parameter2) \
  ...
  DECLARE_FACTORY_MEMBER_0(Declaration)
...
#endif  // AOBA_AST_SYNTAX_FACTORY_H_
