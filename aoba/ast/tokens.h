...
#ifndef AOBA_AST_TOKENS_H_
#define AOBA_AST_TOKENS_H_
...
#include "aoba/ast/lexical_grammar.h"
...
// out of range.
class AOBA_AST_EXPORT Token : public SyntaxTemplate<Syntax, TokenKind> {
...
// Name
//
class AOBA_AST_EXPORT Name final : public Token {
...
// Punctuator
//
class AOBA_AST_EXPORT Punctuator final : public Token {
...
// RegExpSource
//
class AOBA_AST_EXPORT RegExpSource final : public SyntaxTemplate<Syntax> {
