...
#ifndef AOBA_AST_EXPRESSIONS_H_
#define AOBA_AST_EXPRESSIONS_H_
...
// Expression
//
class AOBA_AST_EXPORT Expression : public Syntax {
...
// ArrayInitializer
//
class AOBA_AST_EXPORT ArrayInitializer final
...
//
class AOBA_AST_EXPORT AssignmentExpression final
...
// BinaryExpression
//
class AOBA_AST_EXPORT BinaryExpression final
    : public SyntaxTemplate<Expression, TokenKind> {
...
// CallExpression
//
class AOBA_AST_EXPORT CallExpression final
    : public SyntaxTemplate<Expression> {
...
// CommaExpression
//
class AOBA_AST_EXPORT CommaExpression final
    : public SyntaxTemplate<Expression> {
...
//
class AOBA_AST_EXPORT ConditionalExpression final
    : public SyntaxTemplate<Expression> {
...
//
class AOBA_AST_EXPORT ComputedMemberExpression final
    : public SyntaxTemplate<Expression> {
...
// DelimiterExpression
//
class AOBA_AST_EXPORT DelimiterExpression final
    : public SyntaxTemplate<Expression> {
...
// ElisionExpression
//
class AOBA_AST_EXPORT ElisionExpression final
    : public SyntaxTemplate<Expression> {
...
// GroupExpression
//
class AOBA_AST_EXPORT GroupExpression final
    : public SyntaxTemplate<Expression> {
...
// MemberExpression
//
class AOBA_AST_EXPORT MemberExpression final
    : public SyntaxTemplate<Expression> {
...
// NewExpression
//
class AOBA_AST_EXPORT NewExpression final : public SyntaxTemplate<Expression> {
...
// ObjectInitializer
//
class AOBA_AST_EXPORT ObjectInitializer final
    : public SyntaxTemplate<Expression> {
...
// ParameterList
//
class AOBA_AST_EXPORT ParameterList final : public SyntaxTemplate<Syntax> {
...
// Property
//
class AOBA_AST_EXPORT Property final : public SyntaxTemplate<Syntax> {
...
// ReferenceExpression
//
class AOBA_AST_EXPORT ReferenceExpression final
    : public SyntaxTemplate<Expression> {
...
//
class AOBA_AST_EXPORT RegExpLiteralExpression final
    : public SyntaxTemplate<Expression> {
...
// Tuple
//
class AOBA_AST_EXPORT Tuple final : public SyntaxTemplate<Syntax> {
...
// UnaryExpression
//
class AOBA_AST_EXPORT UnaryExpression final
    : public SyntaxTemplate<Expression, TokenKind> {
...
AOBA_AST_EXPORT bool IsExpression(const Node& node);
AOBA_AST_EXPORT bool IsKnownSymbol(const Node& node);
AOBA_AST_EXPORT bool IsMemberExpression(const Node& node);

}  // namespace ast
}  // namespace aoba

#endif  // AOBA_AST_EXPRESSIONS_H_
