...
#ifndef AOBA_AST_ERROR_CODES_H_
#define AOBA_AST_ERROR_CODES_H_
...
AOBA_AST_EXPORT base::StringPiece ErrorStringOf(int error_code);

}  // namespace ast
}  // namespace aoba

#endif  // AOBA_AST_ERROR_CODES_H_
