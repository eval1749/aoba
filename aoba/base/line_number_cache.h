...
#ifndef AOBA_BASE_LINE_NUMBER_CACHE_H_
#define AOBA_BASE_LINE_NUMBER_CACHE_H_
...
class AOBA_BASE_EXPORT LineNumberCache final {
 public:
...
#endif  // AOBA_BASE_LINE_NUMBER_CACHE_H_
