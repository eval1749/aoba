...
#ifndef AOBA_BASE_MEMORY_ZONE_ALLOCATOR_H_
#define AOBA_BASE_MEMORY_ZONE_ALLOCATOR_H_
...
class ZoneAllocator {
 public:
  ...
  explicit ZoneAllocator(const ZoneAllocator& other) throw()
      : zone_(other.zone_) {}
  template <typename U>
  ZoneAllocator(const ZoneAllocator<U>& other) throw() : zone_(other.zone_) {}
  template <typename U>
...
#endif  // AOBA_BASE_MEMORY_ZONE_ALLOCATOR_H_
